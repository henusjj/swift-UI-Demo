...
class HotTabVC: UIViewController,UITableViewDelegate,UITableViewDataSource{
//    tableview
...
//    数据
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title="hot组件库";
...
//        数据
        dataList = NSMutableArray.init(array: ["类似微信朋友圈cell","瀑布流","UIdataPicker日期选择器","MKMapView地图控件","模糊效果(毛玻璃)","给图片打马赛克CoreImage","动画","AVplayer"]);
//        UI
        creatTableViewUI();
